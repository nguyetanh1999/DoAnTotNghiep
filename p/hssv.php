<?php
	$sql4 = "SELECT * FROM sinhvien WHERE MSSV='".$_SESSION["username"]."'";
	$kq4 = mysqli_query($link, $sql4);	
	$sql7 = "SELECT FORMAT((IF(HK1 IS NULL,0,HK1)+IF(HK2 IS NULL,0,HK2)+IF(HK3 IS NULL,0,HK3)+IF(HK4 IS NULL,0,HK4)+IF(HK5 IS NULL,0,HK5)+IF(HK6 IS NULL,0,HK6)+IF(HK7 IS NULL,0,HK7))/(IF(HK1 IS NULL,0,1)+IF(HK2 IS NULL,0,1)+IF(HK3 IS NULL,0,1)+IF(HK4 IS NULL,0,1)+IF(HK5 IS NULL,0,1)+IF(HK6 IS NULL,0,1)+IF(HK7 IS NULL,0,1)),2) as DTB FROM hoctap WHERE MSSV='".$_SESSION["username"]."'";
